...
def compare_models(prompt: str) -> dict:
    ...
    gpt4_response, gpt4_latency = call_openai(prompt)
    mini_response, mini_latency = call_openai_mini(prompt)

    gpt4_cost = (
        (len(gpt4_response.split()) / 0.75)
        / 1000
        * COST_PER_1K_OUTPUT_TOKENS["gpt-4o"]
    )

    return {
        "gpt4o_response": gpt4_response,
        "mini_response": mini_response,
        "gpt4o_latency": gpt4_latency,
        "mini_latency": mini_latency,
        "gpt4o_cost_estimate": gpt4_cost,
    }
